...
function sueno_andino_setup_pages() {
    $pages = array(
        'Inicio' => array(
            'content' => '<!-- wp:group {"className":"hero-section","align":"full"} -->
<div class="wp-block-group hero-section">
    <div class="hero-content">
        ...
        <div class="hero-buttons">
            <a href="#servicios" class="wp-block-button__link is-style-primary">Conoce Nuestros Servicios</a>
            <a href="#" class="wp-block-button__link is-style-secondary">Descarga Guía Gratuita</a>
        </div>
...
def main():
    print("=" * 60)
    print("INSTALADOR DE WORDPRESS + TEMA SUEÑO ANDINO")
    print("=" * 60)
    
    wordpress_dir = "wordpress-demo"
    ...
    try:
        server_process = subprocess.Popen(
            ['php', '-S', 'localhost:8080', '-t', wordpress_dir],
        ...
        print("Error: PHP no encontrado. Asegúrate de que PHP esté instalado y en tu PATH.")
